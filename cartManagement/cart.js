...
var items = ["Apple", "Peach", "Banana", "Keyboard", "Mouse", "Headphone", "Bike", "Car", "Yacht"];
var prices = [1.3, 3, 2.2, 60, 39.99, 200.99, 180, 24999.99, 49999.99];
...
function addToCart(order) {
    ...
    var total = prices[order - 1] * quantityList[order - 1];
